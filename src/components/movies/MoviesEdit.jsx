...
class MusicEdit extends React.Component {
    ...
    render() {
        return (
            <div>
                <Modal isOpen={true} >
                    <ModalHeader >Add to Your Music Library</ModalHeader>
                    <ModalBody>
                        <Form onSubmit={this.handleSubmit} >
                            ...
                            <FormGroup>
                                ...
                                <Input id="isPublic" type="boolean" name="isPublic" value={this.state.isPublic} placeholder="true" onChange={this.handleChange} />
                            </FormGroup>
                            <FormGroup>
